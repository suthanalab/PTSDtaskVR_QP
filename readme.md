...
7. When the project opens, navigate to the desired scene (7.1-for Headset, 7.2-for PC): 

	7.1. PTSDtaskVR_QP\Assets\SuthanaLab\scenes\pilotSpiders.unity
	7.2. PTSDtaskVR_QP\Assets\SuthanaLab\scenes\pilotSpidersPC.unity	
